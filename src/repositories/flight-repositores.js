...
export class FlightRepository extends CrudRepositories {
  ...
  async getAllTheFlightsBasedOnDept_Arrival(
    dept_city,
    arrival_city,
    filters = {},
    sort = {}
    ...
    try {
      ...
      let queryParams = {
        ...
        ...filters, // extra filters being copied from the services layer directly
      };
      const avlFlights = await Flight.find(queryParams)
